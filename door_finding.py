...
def show_result(frame, bbox, depth=None):
    ...
    return frame_showing, frame_output
...
def main():
    ...
    for frames in frame_reader:
        ...
        if boxes.size(0) > 0:
            ...
            frame_showing, frame_output = show_result(detect_img, bbox, get_mean_depth(depth_frame, bbox))
            initialized = True
        else:
            ...
            if initialized:
                ...
                frame_showing, frame_output = show_result(colour_frame, bbox, get_mean_depth(depth_frame, bbox))
            else:
